...
class Bone {
  ...
  boolean isRevolute = true; // can spin? Change direction?
  ...
  void addBone(int chainLength) {
    ...
    for (int i = 0; i < numOfChildren; i++) {
      ...
      // newBone.parent = this;    // set its parents to this bone
  ...
  void calc() {
    ...
    } else {// if we don't have a parent, use these default valuse: 
  ...
  Bone onClick() {
    ...
    if (vToMouse.magSq() < 20 * 20) return this; // if distance to mouse < 20px, return this bone
